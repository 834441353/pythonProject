...
class testModule():
    ...
    def showpic(self):
        ...
        feature.append(self.piccontext[3:5])
        feature.append(self.piccontext[5:7])
        feature.append(self.piccontext[7:9])
        feature.append(self.piccontext[9:11])
        feature.append(self.piccontext[11:13])
        feature.append(self.piccontext[13:])
        # print('-----')
        print(picpath)
...
if __name__ == '__main__':
    testModule('F:\\demores_s\\pythonProject\\test\\txtdoing\\allDataTxt')